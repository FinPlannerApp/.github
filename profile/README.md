...
| :--- | :--- | :--- |
| 🖥️ **[UI (Frontend)](https://github.com/FinPlannerApp/ui)** | The client-facing web application. | Angular, TypeScript, Tailwind |
| ⚙️ **[API (Backend)](https://github.com/FinPlannerApp/api)** | The core RESTful API and business logic. | .NET Core, EF Core, Layered Architecture |
